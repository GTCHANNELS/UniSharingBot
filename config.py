...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002198729946"))
...
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002220806855"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {mention}\n\nI'm Roronoa Zoro File Sharing Bot Created By @Anime10x")
try:
    ADMINS=[]
...
USER_REPLY_TEXT = "If You Want To Watch Anime Please Join In @Anime10x You Will Find All Anime Links"
